...
def some_books(some_authors):
    return [Book(3, 'Economia urbana', 2005, some_authors[2:3], 'Barcelona', 'Ed. Antonio Bosch')]


@pytest.fixture
def some_articles(some_authors):
    return [Article(4, 'O transporte urbano de João Pessoa', 2008, [some_authors[3]], 4, 92, 8)]
